...
namespace OpenGLSandbox
{
    namespace GLWrapper
    {
        class TextureGLFunctionBind : public OpenGLSandbox::GLWrapper::ITextureGLFunction
        {
        private:
            class TextureBinding
            {
            public:
                static GLenum getBindingTarget( GLenum target );
                static GLenum getBindingBaseTarget(GLenum target);
